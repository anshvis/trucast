...
_recipes_pil_prescript(['EpsImagePlugin', 'IptcImagePlugin', 'MpoImagePlugin', 'PngImagePlugin', 'PcdImagePlugin', 'SunImagePlugin', 'BlpImagePlugin', 'GbrImagePlugin', 'MspImagePlugin', 'SpiderImagePlugin', 'ImtImagePlugin', 'McIdasImagePlugin', 'FpxImagePlugin', 'CurImagePlugin', 'GifImagePlugin', 'IcoImagePlugin', 'XbmImagePlugin', 'FitsStubImagePlugin', 'MicImagePlugin', 'BufrStubImagePlugin', 'XVThumbImagePlugin', 'PpmImagePlugin', 'ImImagePlugin', 'WebPImagePlugin', 'Jpeg2KImagePlugin', 'PixarImagePlugin', 'MpegImagePlugin', 'DdsImagePlugin', 'PdfImagePlugin', 'PsdImagePlugin', 'PcxImagePlugin', 'PalmImagePlugin', 'TiffImagePlugin', 'XpmImagePlugin', 'SgiImagePlugin', 'GribStubImagePlugin', 'IcnsImagePlugin', 'TgaImagePlugin', 'BmpImagePlugin', 'Hdf5StubImagePlugin', 'JpegImagePlugin', 'WmfImagePlugin', 'DcxImagePlugin', 'FtexImagePlugin', 'FliImagePlugin'])
